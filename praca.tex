...
Pierwszym opartym o wartości średnie oraz drugim wykorzystującym stosunek gęstości rozkładów prawdopobieństwa.
...
\newcommand{\slowakluczoween}{stream analysis, internet of things, IoT, storm, changepoint detection, Apache Storm}
